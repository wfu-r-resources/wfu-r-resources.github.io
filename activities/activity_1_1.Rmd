...
:::{.question}
R Markdown is a super versatile tool! Most of my lectures and assignments (including this page!) are actually built with R Markdown. `.Rmd` is the file extension for R Markdown documents. An alternative to R Markdown is Quarto, which has the `.qmd` file extension. 
:::
...
**Step 2:** Open `lab_01_your_name.Rmd` in RStudio.

**Step 3:** Click the `knit` button ![](rmarkdown_knit_button.png) at the top of the document. The knitted document is an HTML file that you can share (when you are finished with the lab, you will submit an HTML file on Canvas). You will re-knit your R Markdown file as you complete the lab.
